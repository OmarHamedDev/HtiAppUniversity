...
class DoctorAttendanceListWidget extends StatelessWidget {
    ...
    return Expanded(
      child: BorderContainerStatusWidget(
        child: ListView.separated(itemBuilder: (context, index) {
          return InkWell(
              onTap: () => _navigateToAttendanceDetails(context, attendanceDoctorCubit),
              child: ItemDoctorAttendanceWidget(weekName: "Week ${index+1}" ,));
  ...
  void _navigateToAttendanceDetails(BuildContext context,AttendanceDoctorCubit attendanceDoctorCubit) {
    Navigator.pushNamed(context, PageRouteName.doctorAttendanceDetails , arguments: []);
  }
}
